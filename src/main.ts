...
async function getChangedPushFiles(commits: Array<any>): Promise<ChangedFiles> {
...
async function run(): Promise<void> {
  try {
    ...
    const github: any = core.getInput("github-object")
    ...
    if (github.event_name == "push") {
      ...
      core.setFailed(`Change not initiated by a PR or Push, it was ${github.event_name} instead.`)
      return
    }
